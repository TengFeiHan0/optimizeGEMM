...
int main(){
    ...
    conv3x3s1WinogradTransformKernel(kernel, kernel_tm, kernel_tm2, inch, outch);
    ...
    conv3x3s1Winograd(src, inw, inh, inch, kernel_tm2, packOutH, packOutW, dest, outw, outh, outch);
